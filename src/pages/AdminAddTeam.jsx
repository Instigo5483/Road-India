    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-ink-50 px-4 py-10">
        ...
        >
          ...
          <h1 className="mt-4 text-lg font-bold text-ink-900">{t('admin.teams.created.title')}</h1>
          <p className="mt-2 text-sm text-ink-600">{t('admin.teams.created.customNote')}</p>

          <div className="mt-4 rounded-xl bg-white px-4 py-3 text-left">
            <p className="text-[11px] font-medium uppercase tracking-wide text-ink-400">
              {t('admin.teams.created.idLabel')}
            </p>
            <p className="font-mono text-sm font-semibold text-ink-900">{created.id}</p>
          </div>
  ...
  return (
    <div className="min-h-screen bg-ink-50">
      ...
      <main className="mx-auto max-w-2xl px-4 py-8 sm:px-6 sm:py-12">
        <h1 className="font-display text-2xl font-bold text-ink-900">{t('admin.teams.addNew')}</h1>
        ...
        >
          ...
          <label className="block">
            <span className="mb-1.5 block text-sm font-medium text-ink-700">{t('admin.teams.areaLabel')}</span>
            ...
            <p className="mt-1.5 text-xs text-ink-400">{t('admin.teams.areaHint')}</p>
          </label>

          <div className="grid gap-4 sm:grid-cols-2">
            <label className="block">
              <span className="mb-1.5 block text-sm font-medium text-ink-700">{t('admin.teams.idLabel')}</span>
              <input
                value={id}
          ...
          <p className="text-xs text-ink-400">{t('admin.teams.idPasscodeHint')}</p>
